  ...
  render() {
    return (
      <section className='ticket'>
        ...
        <h3 className='ticket__time'>{<FormattedMessage {...messages.time} />}: {this.props.time}</h3>
        <div className='ticket__price'><h3>{<FormattedMessage {...messages.price} />}: {this.props.price} BYN</h3></div>
